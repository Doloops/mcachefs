 ...
 */
void mcachefs_journal_append ( mcachefs_journal_op op, const char* path, const char* to, mode_t mode, dev_t rdev,
    uid_t uid, gid_t gid, off_t size, struct utimbuf* utimbuf );
