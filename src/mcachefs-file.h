 ...
 */
void
mcachefs_fileid_put(mcachefs_fh_t fh);
...
mcachefs_file_get(mcachefs_fh_t fh);
 ...
 */
void
mcachefs_file_putfd(struct mcachefs_file_t *, int real);
 ...
 */
struct mcachefs_file_t *
mcachefs_file_get_next_file_to_back();
 ...
 */
void
mcachefs_file_dump(struct mcachefs_file_t *mvops);
