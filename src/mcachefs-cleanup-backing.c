...
void mcachefs_backing_append_file ( struct mcachefs_backing_files* filelist, char* path, struct stat* st )
{
...
static void mcachefs_build_backing_files ( struct mcachefs_backing_files* filelist, const char* prefix, int dirfd )
{
    int fd;
    DIR* dp;
    struct dirent *de;
...
void mcachefs_backing_update_metadata ( struct mcachefs_backing_files* filelist )
{
    struct mcachefs_backing_file* file;
...
void mcachefs_backing_sort ( struct mcachefs_backing_files* filelist )
{
