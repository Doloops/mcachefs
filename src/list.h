...
/* 
 * Linux kernel linked list implementation. This file was copied from 2.6.3, and
 * then hacked by Michael Still to work in userspace. Copyright is held by the
 * orginal author, the code is licensed under the GNU GPL however.
 */
